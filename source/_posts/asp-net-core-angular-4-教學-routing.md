...
本篇範例是承襲 [ASP.NET Core + Angular 4 教學 - Web Api CRUD](/article/asp-net-core-angular-4-教學-web-api-crud.html)  
...
[ASP.NET Core + Angular 4 教學 - Routing.zip](https://1drv.ms/u/s!AlHB4uP4MF7Sh3aqXo-x5p_jds3F)